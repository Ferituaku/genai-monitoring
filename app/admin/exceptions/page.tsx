...
const Exceptions = () => {
  ...
  useEffect(() => {
    ...
    const currentSortField =
      (searchParams.get("sort_field") as SortField) || "Timestamp";
  ...
  const handleSearch = () => {
    ...
    updateUrlParams(1, parseInt(pageSize), sortField, sortDirection);
  };
  ...
  const handlePageChange = (newPage: number) => {
    if (newPage >= 1 && newPage <= pagination.totalPages) {
      updateUrlParams(newPage, pagination.pageSize, sortField, sortDirection);
    }
  };
  ...
  const handlePageSizeChange = (value: string) => {
    ...
    updateUrlParams(1, parseInt(value), sortField, sortDirection);
  };
  ...
  const handleSortChange = (value: string) => {
    ...
    updateUrlParams(1, pagination.pageSize, field, direction);
  };
  ...
  return (
    <div className="h-full overflow-y-clip">
      <div className="sticky p-2 z-10">
        <DynamicBreadcrumb />
        <div className="flex flex-col pt-2 lg:flex-row gap-4 mb-4 justify-between">
